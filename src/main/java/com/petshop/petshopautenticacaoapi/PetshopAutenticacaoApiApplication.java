...
public class PetshopAutenticacaoApiApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication app = new SpringApplication(PetshopAutenticacaoApiApplication.class);
		app.run();
	}
